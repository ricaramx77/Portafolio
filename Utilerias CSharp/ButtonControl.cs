...
{  
    ...
    public static void HabilitaVisibilidadBotones(bool p_Habilita, params Button[] botones)
    {
    ...
    public static void HabilitaDisponilbilidadBotones(bool p_Habilita, params Button[] botones)
    {
        for (int x = 0; x <= botones.Length - 1; x++)
        {
